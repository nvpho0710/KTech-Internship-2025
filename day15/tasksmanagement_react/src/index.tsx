            ...
            <nav className="nav-list">
              ...
              {user?.roles?.includes('admin') && (
                <>
                  ...
                  <NavLink className="nav-item" to="/roles">Roles</NavLink>
                </>
              )}
              {user && (
        ...
        <div className="main-content">
          <Routes>
            ...
            <Route path="/users" element={
              <PrivateRoute>
                {user?.roles?.includes('admin') ? <UsersPage /> : <AccessDeniedPage />}
              </PrivateRoute>
            } />
            <Route path="/roles" element={
              <PrivateRoute>
                {user?.roles?.includes('admin') ? <RolesPage /> : <AccessDeniedPage />}
              </PrivateRoute>
            } />

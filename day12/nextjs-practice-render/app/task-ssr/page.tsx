...
export default async function TaskSSRPage() {
  const res = await fetch('https://jsonplaceholder.typicode.com/todos?_limit=10', { cache: 'no-store' });
...
// ...existing code...
  ...
  return (
    <main style={{
      ...
      <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 24, color: "#222" }}>Task List (SSR)</h1>
